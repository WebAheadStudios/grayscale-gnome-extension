...
export const SettingsController = GObject.registerClass(
    {
        GTypeName: 'GrayscaleSettingsController',
        Signals: {
            'setting-changed': {
    ...
    class SettingsController extends GObject.Object implements ExtensionComponent {
...
export type SettingsControllerType = InstanceType<typeof SettingsController>;
