...
import type { PanelIndicator as IPanelIndicator } from './types/ui.js';
 ...
 */
export const GrayscalePanelButton = GObject.registerClass(
    {
        GTypeName: 'GrayscalePanelButton',
    },
...
// Instance type alias for use as TypeScript type annotation
type GrayscalePanelButtonInstance = InstanceType<typeof GrayscalePanelButton>;
...
export class PanelIndicator implements IPanelIndicator, ExtensionComponent {
    private _extension: Extension;
    private _panelButton: GrayscalePanelButtonInstance | null = null;
     ...
     */
    get panelButton(): GrayscalePanelButtonInstance | null {
        return this._panelButton;
    }
