...
export class StateManager extends GObject.Object implements IStateManager, ExtensionComponent {
    ...
    async setMonitorState(
        ...
        try {
            ...
            if (!options.skipEvents) {
                (this as any).emit('monitor-state-changed', monitorIndex, enabled, previousState);
            }
