...
export class ConfigCache extends GObject.Object {
    ...
    getString(key: string, defaultValue?: string): string {
        return this._getValue(key, 'string', defaultValue, () => this._settings.get_string(key));
    }

    getBoolean(key: string, defaultValue?: boolean): boolean {
        return this._getValue(key, 'boolean', defaultValue, () => this._settings.get_boolean(key));
    }
    ...
    getDouble(key: string, defaultValue?: number): number {
        return this._getValue(key, 'double', defaultValue, () => this._settings.get_double(key));
    }
    ...
    setString(key: string, value: string): boolean {
        return this._setValue(key, value, 'string', () => this._settings.set_string(key, value));
    }

    setBoolean(key: string, value: boolean): boolean {
        return this._setValue(key, value, 'boolean', () => this._settings.set_boolean(key, value));
    }
    ...
    setDouble(key: string, value: number): boolean {
        return this._setValue(key, value, 'double', () => this._settings.set_double(key, value));
    }
