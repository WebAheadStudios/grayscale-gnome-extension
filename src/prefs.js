 ...
 */
const KeyboardShortcutSetting = GObject.registerClass(
  {
    GTypeName: "KeyboardShortcutSetting",
  },
  class KeyboardShortcutSetting extends Gtk.Box {
    ...
    _onButtonClicked() {
      const dialog = new ShortcutDialog(this.get_root(), this._settings, this._key);
      dialog.present();
    }
 ...
 */
const MonitorConfigRow = GObject.registerClass(
  {
    GTypeName: "MonitorConfigRow",
  },
 ...
 */
export default class GrayscalePreferences extends ExtensionPreferences {
  ...
  _createMonitorPage(settings) {
    ...
    settings.bind("auto-restore-states", autoRestoreRow, "active", Gio.SettingsBindFlags.DEFAULT);
  ...
  _createAdvancedPage(settings) {
    ...
    settings.bind("auto-enable-startup", autoEnableRow, "active", Gio.SettingsBindFlags.DEFAULT);
    ...
    resetButton.connect("clicked", () => {
      this._showResetDialog(resetButton.get_root(), settings);
    });
  ...
  _showResetDialog(parent, settings) {
